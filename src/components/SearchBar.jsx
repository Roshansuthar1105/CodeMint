...
const SearchResults = motion.div;
                    ...
                    >
                      ...
                      <div className="flex-1 text-left">
                        <div className="text-sm font-medium text-gray-900 dark:text-white
                          ...
                          transition-colors duration-200"
                        >
                          {item.matches?.find(m => m.field === 'name' || m.field === 'title')?.highlighted ? (
                            <HighlightedText 
                              parts={item.matches.find(m => m.field === 'name' || m.field === 'title').highlighted} 
                            />
                          ) : item.title}
                        </div>
